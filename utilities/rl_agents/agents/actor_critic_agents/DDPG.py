...
from Deep_Reinforcement_Learning_Algorithms_with_PyTorch_master.exploration_strategies.OU_Noise_Exploration import (
...
class DDPG(Base_Agent):
    ...
    def save_models(self):
        torch.save(self.critic_local.state_dict(), "Results/critic")
        torch.save(self.actor_local.state_dict(), "Results/actor")
