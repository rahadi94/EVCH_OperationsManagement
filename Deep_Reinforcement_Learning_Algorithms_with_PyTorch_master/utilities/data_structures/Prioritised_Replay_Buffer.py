import numpy as np
import torch
from Deep_Reinforcement_Learning_Algorithms_with_PyTorch_master.utilities.data_structures.Deque import (
    Deque,
)
from Deep_Reinforcement_Learning_Algorithms_with_PyTorch_master.utilities.data_structures.Max_Heap import (
    Max_Heap,
)
...
class Prioritised_Replay_Buffer(Max_Heap, Deque):
    ...
    def update_heap_and_heap_index_to_overwrite(self):
        ...
        if not self.reached_max_capacity:
            ...
            self.deque[self.deque_index_to_overwrite_next].heap_index = (
                self.heap_index_to_overwrite_next
            )
    ...
    def sample(self, rank_based=True):
        ...
        experiences, deque_sample_indexes = (
