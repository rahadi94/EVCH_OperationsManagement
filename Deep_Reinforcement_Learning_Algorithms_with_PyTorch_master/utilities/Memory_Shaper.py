...
class Memory_Shaper(object):
    ...
    def add_adapted_experience_for_an_episode(
        self, episode_ix, action_rules, max_action_length, replay_buffer
    ):
        ...
        for step in range(steps):
            ...
            for action_length in range(2, max_action_length + 1):
                ...
                assert all(
                    [action in range(self.num_actions) for action in action_sequence]
                ), "All actions should be primitive here"
