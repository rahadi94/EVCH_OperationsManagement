...
from Deep_Reinforcement_Learning_Algorithms_with_PyTorch_master.utilities.Utility_Functions import (
    abstract,
)
...
class HER_Base(object):
    ...
    def save_alternative_experience(self):
        ...
        new_states = [
            self.create_state_from_observation_and_desired_goal(observation, new_goal)
    ...
    def sample_from_HER_and_Ordinary_Buffer(self):
        ...
        HER_states, HER_actions, HER_rewards, HER_next_states, HER_dones = (
            self.HER_memory.sample(self.HER_buffer_batch_size)
        )
