...
def data_preparation(facility, date, t_0, size=200):
    # random.seed(42)
    data_path = "/home/kschroer/Documents/Research/EV_Charging_Clusters/Samples/"
    raw_input_path = "/home/kschroer/Documents/Research/EV_Charging_Clusters/Data/"
    cache_path = "/home/kschroer/Documents/Research/EV_Charging_Clusters/Cache/"
    ...
    df = pd.read_csv(
        f"/home/kschroer/Documents/Research/EV_Charging_Clusters/Cache/requests_sample_{facility}_size_limit_{size}.csv"
    )
    df1 = df[
        (df["EntryDate"] == date)
